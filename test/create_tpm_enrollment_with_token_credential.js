...
const argv = require('yargs')
  .usage('Usage: $0 --hostname <DPS HOST NAME> --endorsementKey <ENDORSEMENT KEY> --tenantid <AAD TENANT ID> --clientid <AAD CLIENT ID> --clientsecret <AAD_CLIENT_SECRET>')
  .option('hostname', {
    alias: 'h',
...
serviceClient.createOrUpdateIndividualEnrollment(enrollment).then((enrollmentResponse) => {
    ...
    serviceClient.deleteIndividualEnrollment(enrollmentResponse.responseBody.registrationId).then(
      (_res) => console.log("Enrollment deleted successfully"),
